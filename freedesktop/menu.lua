...
function new(arg)
    ...
    local menu = {
        { "Acessórios", programs["Utility"], utils.lookup_icon({ icon = 'applications-accessories.png' }) },
        { "Desenvolvimento", programs["Development"], utils.lookup_icon({ icon = 'applications-development.png' }) },
        { "Educação", programs["Education"], utils.lookup_icon({ icon = 'applications-science.png' }) },
        { "Jogos", programs["Game"], utils.lookup_icon({ icon = 'applications-games.png' }) },
        { "Gráficos", programs["Graphics"], utils.lookup_icon({ icon = 'applications-graphics.png' }) },
        { "Internet", programs["Network"], utils.lookup_icon({ icon = 'applications-internet.png' }) },
        { "Multimídia", programs["AudioVideo"], utils.lookup_icon({ icon = 'applications-multimedia.png' }) },
        { "Escritório", programs["Office"], utils.lookup_icon({ icon = 'applications-office.png' }) },
        { "Outros", programs["Other"], utils.lookup_icon({ icon = 'applications-other.png' }) },
        { "Configurações", programs["Settings"], utils.lookup_icon({ icon = 'preferences-desktop.png' }) },
        { "Sistema", programs["System"], utils.lookup_icon({ icon = 'applications-system.png' }) },
    }
